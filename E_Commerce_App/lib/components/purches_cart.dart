...
class PurchesCard extends StatefulWidget {
  Product? product;
  Function? delete;
  PurchesCard({this.product, this.delete});

  @override
  State<PurchesCard> createState() =>
      _PurchesCardState(product: product, delete: delete);
}

class _PurchesCardState extends State<PurchesCard> {
  Product? product;
  String? imageUrl;
  Function? delete;
  _PurchesCardState({this.product, this.delete});
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      child: Text("Ürün Adı: " + product!.name!),
                    ),
                    Container(
                      child:
                          Text("Ürün Fiyatı: " + (product!.price!).toString()),
                    ),
                  ],
                ),
              )

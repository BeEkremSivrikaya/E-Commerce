...
class AdminProductCard extends StatefulWidget {
  ...
  Function? delete;
  Function? update;
  AdminProductCard({this.product, this.delete, this.update});

  @override
  State<AdminProductCard> createState() =>
      _AdminProductCardState(product: product, delete: delete, update: update);
}
...
class _AdminProductCardState extends State<AdminProductCard> {
  ...
  Function? delete;
  Function? update;
  _AdminProductCardState({this.product, this.delete, this.update});
